...
Displays text or an image. It is a static element and doesn't allow user interaction. For more information on [label][2] refer official documentation of python.

...
**2. PyAutoGUI :**
This enables you to automate GUI interactions by simulating mouse and keyboard actions.
...
**3. Requests :**
A is a simple yet elegant **HTTP library** for Python, which allows you to send HTTP requests easily. 
...
![flow](./img/flow1.png)![flow2](./img/flow2.png)![flow](./img/flow3.png)

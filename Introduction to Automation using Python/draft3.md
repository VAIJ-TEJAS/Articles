...
<div class="div-blue"> <span class="alert-header">Note:</span> <span class="alert-body">Always save your `pytest` file with the following naming convention that is `test_filename`.</span> </div>
